  ...
  return (
    <div className="space-y-8 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <ActionCard
          title="Farm Calendar"
          description="Plan planting, harvesting, and field activities on a calendar"
          link="/Calendar"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ActionCard
          title="Inventory"
          description="Track seeds, fertilizers, pesticides, and supplies with low-stock alerts"
          link="/Inventory"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ActionCard
          ...
          description="Record water usage, method, duration, and source per field event"
          link="/Irrigation"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ActionCard
          title="Equipment"
          description="Track machinery hours, service schedules, and maintenance history"
          link="/Equipment"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ActionCard
          title="Subsidies & Compliance"
          description="Track EU CAP subsidy applications, deadlines, and approval status"
          link="/Subsidy"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ActionCard
          ...
          description="Timestamped field journal for pests, diseases, equipment notes, and weather events"
          link="/ObservationLog"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ActionCard
          ...
          description="Projected yields for planted crops adjusted for current soil pH and nitrogen levels"
          link="/YieldForecast"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ActionCard
          title="Reports"
          description="Download PDF reports for harvest, soil tests, finances, and fertilization plans"
          link="/Reports"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
