...
function serializeHarvestRecord(record: any) {
  return {
    ...
    expectedYield: record.expectedYield !== null ? Number(record.expectedYield) : null,
  ...
  try {
    ...
    const record = await prisma.harvestRecord.create({
      data: {
        ...
        expectedYield: body.expectedYield !== undefined && body.expectedYield !== '' ? Number(body.expectedYield) : null,
        actualYield,
